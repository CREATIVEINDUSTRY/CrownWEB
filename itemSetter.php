<?php
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            print '
            <article class="CR-Form Service container xs-w100 xs-flex xs-flex-wrap xs-jc-space-between hidden-print">
            ...
            <div class="ubic xs-flex xs-flex-wrap xs-w90 xs-jc-space-between">
