<?php
	...
	define("MY_EMAIL", "ventas@crownbienesraices.com");
   ...
   */
   function setMessageBody ($name, $apellido, $email, $reason, $phone, $message ) {
    $message_body = "Nombre: " . $name."\n\n";
    $message_body = "Apellido: " . $apellido."\n\n";
    $message_body = "Email: " . $email."\n\n";
    $message_body = "Teléfono: " . $phone."\n\n";
    $message_body = "Asunto: " . $reason."\n\n";
