...
<!--Contenido-->
	<article class="CR-App container xs-w90">
        <div class="xs-w100 xs-flex xs-flex-wrap xs-ai-flex-end">
		<div class="xs-w70 md-w30"><img class="xs-w90 sm-w55 md-w100" src="./img/iphone.png" alt=""></div>
		<div class="CR-AppBox xs-w70 md-w70">
			<h4>Próximamente</h4>
			<h3>Descarga</h3>
